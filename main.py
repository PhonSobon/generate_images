...
from process.txt_format import TxtFormatter

def main():
    """
    Main function to generate images with YOLO, XML, and TXT annotations
    ...
    print(f"    Page sizes: {PAGE_SIZES[0]} (Landscape)")
    ...
    for font_idx, font_path in enumerate(all_fonts, 1):
        ...
        for img_num in range(1, IMAGES_PER_FONT + 1):
            ...
            # Generate TXT file with all words from the image
            txt_formatter.generate_txt_file(word_boxes, output_filename)
    ...
    print(f"      - TXT transcriptions: txt_labels/")
    print("=" * 70)
